...
void SceneNode::Update(D3D12Engine* d3dApp)
{
	...
	d3dApp->GetPassConstants().World = XMMatrixTranspose(XMMatrixTranslation(Position.x, Position.y, Position.z) * XMMatrixRotationRollPitchYaw(Rotation.x, Rotation.y, Rotation.z));
